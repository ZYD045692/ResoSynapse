...
export const asyncRoutes: MenuListType[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: 201,
        name: 'userHomePageInfo',
        path: 'userHomePageInfo',
        component: RoutesAlias.UserHomePageInfo,
        meta: {
          title: 'menus.widget.userhomepageinfo',
          keepAlive: false
        }
      },
      {
        ...
        name: 'block',
        path: 'block',
        component: RoutesAlias.Block,
        meta: {
          title: 'menus.widget.block',
          keepAlive: false
        }
      },
      {
        ...
        name: 'module',
        path: 'module',
        component: RoutesAlias.Module,
        meta: {
          title: 'menus.widget.module',
          keepAlive: false
        }
      },
      {
        ...
        path: 'addblock',
        name: 'addblock',
        component: RoutesAlias.AddBlock,
        meta: {
          title: 'menus.widget.addblock',
          keepAlive: false
        }
      },
      {
        ...
        path: 'addmodule',
        name: 'addmodule',
        component: RoutesAlias.AddModule,
        meta: {
          title: 'menus.widget.addmodule',
          keepAlive: false
        }
      },
      {
        ...
        path: 'block/detail',
        name: 'blockdetail',
        component: RoutesAlias.BlockDetail,
        meta: {
          title: 'menus.widget.blockdetail',
          keepAlive: false
        }
      },
      {
        ...
        path: 'module/detail',
        name: 'moduledetail',
        component: RoutesAlias.ModuleDetail,
        meta: {
          title: 'menus.widget.moduledetail',
          keepAlive: false
        }
      },
      {
        id: 208,
        path: 'block/editorder',
        name: 'blockeditorder',
        component: RoutesAlias.EditBlockOrder,
        meta: {
          title: 'menus.widget.editblockorder',
          keepAlive: false
        }
      },
    ]
