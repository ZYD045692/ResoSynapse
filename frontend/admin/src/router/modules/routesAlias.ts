...
export enum RoutesAlias {
  ...
  UserHomePageInfo = '/widget/userHomePageInfo',
  Block = '/widget/block',
  Module = '/widget/module',
  AddBlock = '/widget/block/AddBlock',
  BlockDetail = '/widget/block/BlockDetail',
  EditBlockOrder = '/widget/block/editBlockOrder',
  AddModule = '/widget/module/AddModule',
  ModuleDetail = '/widget/module/ModuleDetail',
  EditModuleOrder = '/widget/module/editModuleOrder',
}
