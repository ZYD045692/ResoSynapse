  ...
  <div class="left-menu-or-dual-menu">
      ...
      <el-scrollbar style="height: calc(100% - 135px)">
        <ul>
          <li v-for="menu in firstLevelMenus" :key="menu.path" @click="handleMenuJump(menu, true)">
            <el-tooltip class="box-item" effect="dark" :content="$t(menu.meta.title)" placement="right" :offset="25"
              :hide-after="0" :disabled="settingStore.dualMenuShowText">
              <div :class="{
                ...
                <i class="iconfont-sys" v-html="menu.meta.icon" :style="{
    ...
    <div class="menu-left" id="menu-left" :class="`menu-left-${theme.theme} menu-left-${collapse ? 'close' : 'open'}`"
      ...
      <div class="header" @click="toHome" :style="{ background: theme.background }">
        ...
        <img :src="favicon" class="favicon-img" aria-hidden="true" v-if="!isDualMenu" :style="{
          width: '24px',
          height: '24px',
          marginLeft: '30px'
        }">
        <p :class="{ 'is-dual-menu-name': isDualMenu }"
