    ...
    <div class="content">
      <div class="left-wrap">
        <div class="user-wrap box-style">
          ...
          <p class="des">ResoSynapse 是一款漂亮的双端系统.</p>

          <div class="outer-info">
            <div>
              <i class="iconfont-sys">&#xe72e;</i>
              <span>2214845593@qq.com</span>
            </div>
            <div>
              <i class="iconfont-sys">&#xe608;</i>
              <span>交互专家</span>
...
<script setup lang="ts">
  ...
  const form = reactive({
    ...
    mobile: '15294742202',
    address: '河南省郑州市高新区莲花街100号河南工业大学',
    sex: '1',
    des: 'ResoSynapse 是一款漂亮的双端系统.'
  })
  ...
  const lableList: Array<string> = ['专注设计', '很有想法', '菜~', '一半耳机', '夜猫子', '喜欢张译丹']
